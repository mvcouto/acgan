...
def get_data():
    x_melanoma_train, y_melanoma_train = get_dir_data(os.path.join('.', 'images224', 'train', 'melanoma'), 1)
    x_melanoma_test, y_melanoma_test = get_dir_data(os.path.join('.', 'images224', 'validation', 'melanoma'), 1)
    x_other_train, y_other_train = get_dir_data(os.path.join('.', 'images224', 'train', 'outros'), 0)
    x_other_test, y_other_test = get_dir_data(os.path.join('.', 'images224', 'validation', 'outros'), 0)
...
def build_generator(latent_size):
    ...
    cnn.add(Dense(24 * 24 * 768, input_dim=latent_size, activation='relu'))
    cnn.add(Reshape((24, 24, 768)))
